...
if (isset($_GET["did"])) {
    $did = $_GET["did"];
    $result = mysqli_query($con, "DELETE from admin where admin_id='{$did}'") or die(mysqli_error($con));
    if ($result) {
                                ...
                                <div class="col-xs-12 data_tables">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-white">
                                            <i class="fa fa-table"></i> Admin List
                                        </div>
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>
                                                        ...
                                                        <td> <a href='edit-admin.php?eid={$row["admin_id"]}'> Edit </a> |<a href='?did={$row["admin_id"]}'> Delete </a></td>
                                                    </tr>";
}
?>
