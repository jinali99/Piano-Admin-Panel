                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block p-t-25">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                ...
                                                <tbody>
<?php
$result = mysqli_query($con, "Select * from course inner join instrument on instrument.instrument_id = course.instrument_id inner join musical_academy on musical_academy.musical_academy_id = course.academy_id") or die(mysqli_error($con));
