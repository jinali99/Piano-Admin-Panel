...
{
    $did =$_GET["did"];
    $result= mysqli_query($con,"DELETE from user  where user_id ='{$did}'") or die(mysqli_error($con));
    if($result)
    {
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)){
                                                        ...
                                                        <td> <a href='edit-user.php?eid={$row["user_id"]}'> Edit </a> |<a href='?did={$row["user_id"]}'>  Delete </a></td>
                                                    </tr>";
                                                    }
