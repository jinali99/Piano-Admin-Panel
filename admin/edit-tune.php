...
$eid=$_GET["eid"];
$result = mysqli_query($con,"select * from tune where tune_id='{$eid}'") or die(mysqli_error($con));
...
if($_POST){
    ...
    $result = mysqli_query($con, "UPDATE `tune` SET `tune_name`='{$txtTuneName}',`tune_url`='{$txtTuneUrl}',`instrument_id`='{$txtInstrumentId}' WHERE `tune_id`='{$eid}'") or die(mysqli_error($con));
    if($result){
        header("location:view-tune.php");
    }
}
                                        ...
                                        <div class="card-block m-t-35">
                                            <form action="" class="form-horizontal  login_validator" id="form_block_validator" method="POST">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input value="<?php echo $row["tune_name"]?>" type ="text" id="required2" name="txtTuneName" class="form-control" required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input value="<?php echo $row["tune_url"]?>" type="text" id="required2" name="txtTuneUrl" class="form-control" required>
                                                    </div>
